...
const POOL_TYPES = ["writing", "images", "questions", "counts", "dismantle", "reverse", "scramble", "repeat"];
...
function getUserBucket(userId) {
  if (!history.has(userId)) {
    history.set(userId, { writing: [], images: [], questions: [], counts: [], dismantle: [], reverse: [], scramble: [], repeat: [] });
  }
